...
variable "params" {
  default = [
    ...
    { name = "roboshop.prod.cart.redis_host", value = "elasticache-prod.prkv4e.clustercfg.use1.cache.amazonaws.com", type = "String" },
    ...
    { name = "roboshop.prod.user.redis_host", value = "elasticache-prod.prkv4e.clustercfg.use1.cache.amazonaws.com", type = "String" },
