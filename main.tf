...
variable "params" {
  default = [
    ...
    { name = "roboshop.dev.cart.redis_host", value = "http://redis-dev.smitdevops.online", type = "String" },
    { name = "roboshop.dev.cart.catalogue_host", value = "http://catalogue-dev.smitdevops.online", type = "String" },
